from types_graph import Ontology, LLMClient, Edge, Document
...
class GraphMaker:
    ...
    def __init__(
        ...
        llm_client: LLMClient = OllamaClient(
            model="llama3:8b", temperature=0.2, top_p=1
        ),
        verbose: bool = False,
    ):
    ...
    def system_message(self) -> str:
        return (
            ...
            "[\n"
            "   {\n"
            '       node_1: Required, an entity object with attributes: {"type": "as per the ontology", "id": "Name of the entity"},\n'
            '       node_2: Required, an entity object with attributes: {"type": "as per the ontology", "id": "Name of the entity"},\n'
    ...
    def from_document(
        ...
        graph = self.from_text(doc.page_content)
        for edge in graph:
    ...
    def from_documents(
        ...
        for index, doc in enumerate(docs):
            ...
            graph.append([subgraph,doc.page_content])
